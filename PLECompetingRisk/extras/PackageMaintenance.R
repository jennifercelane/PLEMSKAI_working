...
OhdsiRTools::checkUsagePackage("PLECompetingRisk")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/PLECompetingRisk.pdf")
shell("R CMD Rd2pdf ./ --output=extras/PLECompetingRisk.pdf")
...
OhdsiRTools::createRenvLockFile("PLECompetingRisk")
