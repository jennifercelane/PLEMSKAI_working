...
OhdsiRTools::checkUsagePackage("PLE_oa_PSmatching")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/PLE_oa_PSmatching.pdf")
shell("R CMD Rd2pdf ./ --output=extras/PLE_oa_PSmatching.pdf")
...
OhdsiRTools::createRenvLockFile("PLE_oa_PSmatching")
