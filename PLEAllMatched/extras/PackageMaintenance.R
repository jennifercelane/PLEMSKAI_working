...
OhdsiRTools::checkUsagePackage("PLEAllMatched")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/PLEAllMatched.pdf")
shell("R CMD Rd2pdf ./ --output=extras/PLEAllMatched.pdf")
...
OhdsiRTools::createRenvLockFile("PLEAllMatched")
